							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="vianda_id" id="vianda_id" class="form-control input-sm" placeholder="ID de Vianda">
									</div>
								</div>
							</div>
							<div class="form-group">
								        <input type="text" name="persona_id" id="persona_id" class="form-control input-sm" placeholder="ID de Persona">
							</div>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
